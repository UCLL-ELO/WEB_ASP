<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Toekomst van elektronica.aspx.cs" Inherits="ASP_MAIN.WebForm1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="headContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h1>Toekomst van de elektronica</h1>
    <p>Er is momenteel een chronisch tekort aan technologische hooggeschoolden, dus met een diploma op zak is er 
werk te over.
